...
Public Class Splash
    Private Sub tmrsplash_Tick(sender As Object, e As EventArgs) Handles tmrsplash.Tick
        ...
        Static i As Integer
        Dim imgs() As Image = {My.Resources.splash1, My.Resources.splash2, My.Resources.splash3, My.Resources.splash4, My.Resources.splash5, My.Resources.navelquestlogo}
        If i < 6 Then
